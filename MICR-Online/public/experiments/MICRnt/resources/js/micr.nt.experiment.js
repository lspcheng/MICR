...
function Experiment(params, firebaseStorage) {
  ...
  ****************************/
  ...
  var initTrials = function(blockName) {
    ...
    // var stimuli = jsPsych.randomization.shuffle(params.trialStim) // Randomize manually using jsPsych.randomization
            ...
            // The function first splits the string (by ', ') into keyValues pairs;
            // then, it splits those into Key and Value, creating an object that can be read as a key value pair
    ...
    var trial_procedure = {
      timeline: [fixationScreen, sentenceAudio,ratingResponse],
  ...
  ****************************/
  ...
  var initBlocks = function() {
    ...
    console.log(params.condition)  // print condition
    ...
    // For each block in the shuffledBlocks list,  (using Underscore for-loop)
