...
cat(imageList.json)
write(imageList.json, "./stimLists_MICRaxb/imageList.json")
```
...
```{r jsondata-kvs-duplicateblocks}

stimulusDF_condAB <- stimulusDF %>%
  mutate(speakerGuise = speakerIdentity) %>%
  mutate(guiseName = paste(speaker, speakerGuise, sep = "-")) %>%
  mutate_if(is.character, as.factor) %>%
  mutate(axbText = case_when(speakerGuise == "CN" ~ "<div class=\"vertical-center\" style='width:60%;'><img src=\"resources/images/resources/images/CN_flag_950x500.png\" style=\"width:125px;height:65px;opacity:0.5;\"><p style='font-weight:bold;'>Does the middle word sound more like the first word (A) or the last word (B)?</p> <br> <div class=\"container\"> <div id=\"a-box\"> <p class=\"title-text\">A</h3></p> </div> <div id=\"x-box\"> <p class=\"title-text\">X<p> </div> <div id=\"b-box\"> <p class=\"title-text\">B</p></div> <br> <div style='float: left;padding-left:30px;'><p>Press '1' for A</p></div><div style='float: right;padding-right:30px;'><p>Press '0' for B</p> </div> </div></div>",
                            speakerGuise == "MI" ~"<div class=\"vertical-center\" style='width:60%;'><img src=\"resources/images/resources/images/US_flag_950x500.png\" style=\"width:125px;height:65px;opacity:0.5;\"><p style='font-weight:bold;'>Does the middle word sound more like the first word (A) or the last word (B)?</p> <br> <div class=\"container\"> <div id=\"a-box\"> <p class=\"title-text\">A</h3></p> </div> <div id=\"x-box\"> <p class=\"title-text\">X<p> </div> <div id=\"b-box\"> <p class=\"title-text\">B</p></div> <br> <div style='float: left;padding-left:30px;'><p>Press '1' for A</p></div><div style='float: right;padding-right:30px;'><p>Press '0' for B</p> </div> </div></div>")) %>%
  select(wordStim, speaker, sentNum, order, step, speakerIdentity, speakerGuise, guiseName, raised_answer, trial_role, axbText)
stimulusDF_condAB

stimulusDF_condCD <- stimulusDF %>%
  mutate(speakerGuise = case_when(speakerIdentity == "MI" ~ "CN",
                                  speakerIdentity == "CN" ~ "MI")) %>%
  mutate(guiseName = paste(speaker, speakerGuise, sep = "-")) %>%
  mutate_if(is.character, as.factor) %>%
  mutate(axbText = case_when(speakerGuise == "CN" ~ "<div class=\"vertical-center\" style='width:60%;'><img src=\"resources/images/resources/images/CN_flag_950x500.png\" style=\"width:125px;height:65px;opacity:0.5;\"><p style='font-weight:bold;'>Does the middle word sound more like the first word (A) or the last word (B)?</p> <br> <div class=\"container\"> <div id=\"a-box\"> <p class=\"title-text\">A</h3></p> </div> <div id=\"x-box\"> <p class=\"title-text\">X<p> </div> <div id=\"b-box\"> <p class=\"title-text\">B</p></div> <br> <div style='float: left;padding-left:30px;'><p>Press '1' for A</p></div><div style='float: right;padding-right:30px;'><p>Press '0' for B</p> </div> </div></div>",
                            speakerGuise == "MI" ~"<div class=\"vertical-center\" style='width:60%;'><img src=\"resources/images/resources/images/US_flag_950x500.png\" style=\"width:125px;height:65px;opacity:0.5;\"><p style='font-weight:bold;'>Does the middle word sound more like the first word (A) or the last word (B)?</p> <br> <div class=\"container\"> <div id=\"a-box\"> <p class=\"title-text\">A</h3></p> </div> <div id=\"x-box\"> <p class=\"title-text\">X<p> </div> <div id=\"b-box\"> <p class=\"title-text\">B</p></div> <br> <div style='float: left;padding-left:30px;'><p>Press '1' for A</p></div><div style='float: right;padding-right:30px;'><p>Press '0' for B</p> </div> </div></div>")) %>%
...
stimulusDF_condEF <- stimulusDF %>%
  mutate(speakerGuise = "BL") %>%
  mutate(guiseName = paste(speaker, speakerGuise, sep = "-")) %>%
  mutate_if(is.character, as.factor) %>%
  mutate(axbText = "<div class=\"vertical-center\" style='width:60%;'><p style='font-weight:bold;'>Does the middle word sound more like the first word (A) or the last word (B)?</p> <br> <div class=\"container\"> <div id=\"a-box\"> <p class=\"title-text\">A</h3></p> </div> <div id=\"x-box\"> <p class=\"title-text\">X<p> </div> <div id=\"b-box\"> <p class=\"title-text\">B</p></div> <br> <div style='float: left;padding-left:30px;'><p>Press '1' for A</p></div><div style='float: right;padding-right:30px;'><p>Press '0' for B</p> </div> </div></div>") %>%
  select(wordStim, speaker, sentNum, order, step, speakerIdentity, speakerGuise, guiseName, raised_answer, trial_role, axbText)
stimulusDF_condEF

stimulusDF <- rbind(stimulusDF_condAB, stimulusDF_condCD, stimulusDF_condEF)
stimulusDF
...
```{r jsondata-kvs-subsetblocks, include=F}
# Add in blocks
...
# List factors of quarter the number of stims (e.g. one of four conditions)
print_factors(nStims/4)
...
TODO: Update the block structure and change the column name to subset by.
...
# Add your list of blocks
## (Option 1) Create list of block names (as above, but only the unique blocks) 
#blockList <- paste0("cond",rep(LETTERS[1:2]))

## (Option 2) Write out your full list
blockList <- c("S3-MI", "S9-CN", "S3-CN", "S9-MI", "S3-BL", "S9-BL")
