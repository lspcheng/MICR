...
stimulusDF_condAB <- stimulusDF %>%
  ...
  select(wordStim, speaker, sentNum, order, step, speakerIdentity, speakerGuise, guiseName, raised_answer, trial_role)
stimulusDF_condAB
...
stimulusDF <- rbind(stimulusDF_condAB, stimulusDF_condCD)
stimulusDF

summary(stimulusDF_condCD)
summary(stimulusDF)
...
blockList <- c("S3-MI", "S9-CN", "S3-CN", "S9-MI")
