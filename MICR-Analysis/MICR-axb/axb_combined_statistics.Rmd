...
```{r}
au_data_ind_fixef_noBL_max %>% filter(slope_out == TRUE | xint_out == TRUE)
au_data_ind_fixef_noBL_max %>% filter(slope_out == TRUE)
au_data_ind_fixef_noBL_max %>% filter(xint_out == TRUE)
au_data_ind_fixef_noBL_max %>% filter(slope_out == TRUE & xint_out == TRUE)
```
