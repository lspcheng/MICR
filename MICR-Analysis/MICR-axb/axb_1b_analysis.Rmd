...
condata.read <- condata.read %>% 
  ...
  subset(participantId != '602d9608316d30263e3b94f2') %>%   # 167 (99%) guy
  subset(participantId != '5ca9603a78958e0016c4ff01') %>%   # 46% low effort
...
# C
# 167/168 # 0.9940476 subj 602d9608316d30263e3b94f2
# 77/168 # 0.4583333 subj 5ca9603a78958e0016c4ff01
...
quesdata.demo <- quesdata.demo %>%
  ...
  mutate(Gender = mgsub(Gender, c("woman.*|female|cis female", "male|cis male|.*male", "non-binary|non binary|nonbinary"), c("f", "m", "nb"))) %>%
